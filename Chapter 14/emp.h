// emp.h -- заголовочный файл дл€ класса abstr_emp и его дочерних классов
#ifndef EMP_H_
#define EMP_H_
...
class highfink: public manager, public fink { // надзор за управл€ющим
	public:
		highfink();
