...
int newplace()
{
    ...
    pd1 = new double[N];           // помещение массива в кучу
    pd2 = new (buffer) double[N];  // помещение массива double в область buffer
    for (i = 0; i < N; i++)
    ...
    pd4 = new (buffer) double[N];   // перезапись старых данных
    for (i = 0; i < N; i++)
